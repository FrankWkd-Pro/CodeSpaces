...
transition:
    all.5s ease, max - height.5s ease;
    max - height : 0;
overflow:
    hidden;
left:
...
.navbar > nav.navbar - left > * : not( : first - child){
    margin - left : 31px
                                      ...
                                      .navbar
    > nav.navbar - right > * : not( : first - child),
    .navbar > nav #navbar_login_status > * : not( : first - child){
        margin - left : 24px
    }

                                                 .navbar
        > nav #navbar_login_status{
              min - width : 120px
          }
...
.dropdown >.dropdown - menu.quick - search - menu > * : first - child{
    margin - top : 0
                                                                    ...
                                                                    .dropdown >
                                                        .dropdown - menu.quick - search - menu > * : not( : first - child){
                                                            margin - top : 0
                                                        }

                                                        .dropdown
    >.dropdown - menu.quick - search - menu > * : last - child {
    margin - bottom : 0;
    padding - bottom : 10px
}
...
.dropdown >.dropdown - menu > * : not( : first - child){
    ...
    >.dropdown - menu > * : last - child{
          margin - bottom : 10px
                                       ...
                                       .syntaxhighlighter a,
    .syntaxhighlighter div, .syntaxhighlighter code, .syntaxhighlighter table, .syntaxhighlighter table td, .syntaxhighlighter table tr, .syntaxhighlighter table tbody, .syntaxhighlighter table thead, .syntaxhighlighter table caption, .syntaxhighlighter textarea, pre[class *= "brush:"][class *= "language-"], pre[class *= "brush:"] {
...
.syntaxhighlighter.ie.toolbar{
    ...
    .syntaxhighlighter.printing.line.alt2.content, .syntaxhighlighter.printing.line.highlighted.number, .syntaxhighlighter.printing.line.highlighted.alt1.content, .syntaxhighlighter.printing.line.highlighted.alt2.content{
...
.commentform table td input{
    ...
    .sendMsg2This : link,
    .sendMsg2This : visited, .sendMsg2This : active {
    font - size : 12px;
    text - decoration : none;
background:
    url("/images/icoMsg.gif") no - repeat top left;
    padding - left : 20px
}
...
#sidebar_news_content : not(pre, div)> code, .cnblogs - markdown : not(pre, div)> code, .blogpost - body : not(.cnblogs - markdown) : not(pre, div, td)> code {
                font -
    family : ui - monospace,
    SFMono - Regular, SF Mono, Menlo, Consolas, Liberation Mono, monospace, sans - serif;
font - size : 12px;
padding : 0 5px;
line - height : 1.8;
margin : 0 3px;
...
pre,
    pre code, pre code table, .hljs - engine pre, .hljs - engine pre code {
...
pre.cnb - over - length - code - block{
    ...
    max - height
                                     ...
                                     .prismjs -
    engine pre.line - numbers code span{
        font - family : inherit
    }
...
.cnblogs_code ol li{
    ...
    .cnblogs_code_toolbar a : link, .cnblogs_code_toolbar a : visited, .cnblogs_code_toolbar a : active, .cnblogs_code_toolbar a : link img, .cnblogs_code_toolbar a : visited img {
...
.dp - highlighter.collapsed ol{
    margin : 0
          ...
          .dp -
    highlighter.collapsed ol li{
        display : none
    }

        .dp -
    highlighter.printing{
        border : none
    }

        .dp -
    highlighter.printing.tools{
        display : none !important
    }

        .dp -
    highlighter.printing li{
...
padding:
    3px 8px 3px 10px;
font:
    9px Verdana, Geneva, Arial, Helvetica, sans - serif;
color:
#c0c0c0;
    background - color : #f8f8f8;
    padding - bottom : 10px;
...
height:
    52px;
background:
    url("//assets.cnblogs.com/images/upup.gif") no - repeat;
    text - align : center;
cursor:
    pointer;
    margin - top : 2px;
...
height:
    52px;
background:
    url("//assets.cnblogs.com/images/downdown.gif") no - repeat;
    text - align : center;
cursor:
    pointer;
    margin - top : 2px;
...
#navbar_lite_mode_on {
    ...
    pre.best - text, pre.reply - text{
        white - space : pre - wrap
                                     ...
                                     .blogpost -
                         body - html span[style *= "font-size: x-small"],
        .blogpost - body - html span[style *= "font-size:x-small"], .blogpost - body - html span[style *= "font-size: xx-small"], .blogpost - body - html span[style *= "font-size:xx-small"]{
...
#cnblogs_c2 img {
    ...
    .medium - zoom - overlay{
        ...
        zoom - image-- opened{
            z - index : 99
                   ...
                   .sidebar -
        card - title - a,
        a.sidebar - card - title - a : link, a.sidebar - card - title - a : visited {
    ...
    position:
        absolute;
    right:
        var(--cnb - code - toolbar - spacing);
    top:
        calc(var(--cnb - code - toolbar - spacing) + var(--cnb - code - toolbar - offset - top, 0 %));
        text - shadow : none;
    ...
    position:
        relative;
    background:
        var(--cnb - code - toolbar - bg, inherit);
        mix - blend - mode : var(--cnb - code - toolbar - mix - blend - mode);
    opacity:
        var(--cnb - code - toolbar - opacity)
    }
    ...
    @keyframes fadeIn {
        ...
        {
        opacity:
            var(--cnb - code - toolbar - initial - opacity)
        }
    }
...
#comment_nav a {
    ...
    pre.hljs - lines - highlighted code.hljs[data - lines - highlight].hljs - line - numbers, pre.hljs - lines - highlighted code[data - lines - highlight].hljs - line - numbers{
        padding - left : 0
                                                                                                                                                                          ...
                                                                                                                                                                          pre.hljs -
                                                                                                  lines - highlighted code.hljs[data - lines - highlight][data - dark - theme],
        pre.hljs - lines - highlighted code[data - lines - highlight][data - dark - theme]{
            --highlighted - line - bg : var(--highlighted - line - bg - dark)
        }

                           pre.hljs -
            lines - highlighted code.hljs[data - lines - highlight] table.hljs - ln,
    ...
    pre.hljs - lines - highlighted code.hljs[data - lines - highlight] table.hljs - ln tbody, pre.hljs - lines - highlighted code[data - lines - highlight] table.hljs - ln tbody{
        width : 100 %
                                                                                                                                                                         ...
                                                                                                                                                                         pre.hljs -
                                                                                                  lines - highlighted code.hljs[data - lines - highlight] table.hljs - ln tr : before,
...
#d1e3c9;
    ...
    pre.hljs - lines - highlighted code.hljs[data - lines - highlight] table.hljs - ln tr td.hljs - ln - line.hljs - ln - code, pre.hljs - lines - highlighted code[data - lines - highlight] table.hljs - ln tr td.hljs - ln - line.hljs - ln - code{
        width : 100 %
                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                 pre.hljs -
                                                                                                                                    lines - highlighted code.hljs[data - lines - highlight] : not(.hljs - line - numbers) span.hljs - lines - highlight - wrapper,
...
#d1e3c9;
    ...
    pre.prismjs - lines - highlighted{
        ...
        pre.prismjs - lines - highlighted ::before{
            box - sizing : border - box
                              ...
                              pre.prismjs -
            lines - highlighted,
        pre.prismjs - lines - highlighted[class *= 'language-'], pre.prismjs - lines - highlighted.line - numbers {
        padding - left : var(--spacing - left);
        padding - right : var(--spacing - right)
    }
    ...
    pre.prismjs - lines - highlighted[class *= 'language-'] : not(.line - numbers){
        --spacing - left : 1em
                                                              ...
                                                              pre.prismjs
        - lines - highlighted[class *= 'language-'].line - numbers{
              --spacing - left : 3.8em
          }

                                                           pre.prismjs
        - lines - highlighted code.highlighter - prismjs[data - lines - highlight] {
    position:
        relative;
        min - width : 100 % ;
    display:
    ...
    pre.prismjs - lines - highlighted code.highlighter - prismjs[data - lines - highlight][data - dark - theme]{
        --highlighted - line - bg : var(--highlighted - line - bg - dark)
                                                         ...
                                                         pre.prismjs -
        lines - highlighted code.highlighter - prismjs[data - lines - highlight] span.highlighted - line {
    background:
#d1e3c9;
    background:
#d1e3c9;
...
#d1e3c9;
    ...
    pre.prismjs - lines - highlighted.line - numbers - rows span{
        padding - right : 0
                                                       ...
                                                       pre[data - mac - style][class *= 'language-']
                                                           .highlighter -
        prismjs,
...
#fe5f59;
    background:
        var(--mac - style - color - red, #fe5f59);
        border - radius : 50 % ;
    ...
    .current - collection.collapsed.current - collection - title - arrow{
        transform : rotate(-90deg)
                                                                       ...
                                                                       .current -
        collection.collapsed.current - collection - arrow{
            transform : rotate(0)
        }

                                                        .current -
        collection.collapsed.current - collection - footer{
            display : none
        }
...
#cnblogs_post_body.current - collection a : link, #cnblogs_post_body.current - collection a : visited, #cnblogs_post_body.current - collection a : hover, #cnblogs_post_body.current - collection a : active {
    ...
    background:
        rgba(255, 255, 255, .9);
    background:
        var(--cnblogs - current - collection - highlight - color)
    }
...
# 000
        ...
        text - decoration : none
                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                  collection - footer{
                                                                                                                                                                                                                      padding : 10px 15px
                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                   .current -
                                                                                                                                                                                                                  collection - collapse - button - wrapper {
    display:
        flex;
        align - items : center;
        justify - content : end;
    ...
    background:
        rgba(255, 255, 255, .7);
    background:
        var(--cnblogs - current - collection - hover - color)
    }
    ...
    background:
        rgba(255, 255, 255, .8);
    background:
        var(--cnblogs - current - collection - active - color)
    }
    ...
    .current - collection - publish - date{
        ...
        shrink{
            ...
            .cnblogs -
        current - collection - pinned - navigator {
    color:
# 000;
    color:
# 000;
    color:
        var(--cnblogs - current - collection - color);
    background:
        transparent;
        border - radius : 4px
    }
    ...
    content:
        '';
    background:
        url("/images/push-pin-filled.svg");
    width:
        .9em;
    height:
        .9em
    ...
    .cnb - over - length - code - block - collapsed.cnb - over - length - code - block - toggler - title, .cnb - over - length - code - block - collapsed.cnb - over - length - code - block - toggler - icon{
        opacity : .8
                                                                                                                                                                                                             ...
                                                                                                                                                                                                             .cnb -
                                                                                                              over - length - code - block - expanded {
    position:
        relative;
        animation - duration : .2s;
...
#fff;
    ...
    .cnb - over - length - code - block - expanded.cnb - over - length - code - block - toggler : hover{
        opacity : 1
                                                                                                      ...
                                                                                                      .cnb -
        over - length - code - block - expanded.cnb - over - length - code - block - toggler - title {
    padding:
        0 0 0 4px;
    ...
    .cnb - over - length - code - block.code - theme - dark : not(.cnb - over - length - code - block - expanded).cnb - over - length - code - block - toggler{
        color : #fff
                                                                                                                                                           ...
                                                                                                                                                           .cnb
        - over - length - code - block - toggler {
    position:
        absolute;
    color:
# 000;
    ...
    background:
        var(--olcb - folder - code - block - toggler - bg);
        -webkit - user - select : none;
        -moz - user - select : none;
        user - select : none;
        min - height : 20px;
    ...
    .tree - categories - item[data - haschild = false].tree - categories - item - toggler - arrow{
        visibility : hidden
                                                                                                ...
                                                                                                .tree -
            categories - item[data - expanded = true] >
            .tree - categories - item - container.tree - categories - item - toggler - arrow{
                transform : rotate(90deg)
            }

            .tree -
                categories - item[data - expanded = true] >
            .tree - categories - item - container.tree - categories - item - title - left : before {
    ...
    background:
        rgba(34, 34, 34, .8);
    background:
        var(--cnblogs - charm - bar - bg - color);
    color:
        rgba(255, 255, 255, .98);
    color:
        rgba(255, 255, 255, .98);
    color:
        var(--cnblogs - charm - bar - highlight - color);
    transition:
    ...
    background:
        rgba(34, 34, 34, .6);
    background:
        var(--cnblogs - charm - bar - hover - color)
    }
...
.wb - drag.cnblogs - toc - pinned - navigator{
    opacity : 10 %
                                    ...
                                    body{
                                        ...
                                        .cnblogs -
    toc - pinned - navigator{
        border - radius : 4px
    }

                       .cnblogs -
    toc - pinned - navigator.cnblogs - toc - title{
        padding - top : 5px
    }

                                                 .cnblogs -
    toc - pinned - navigator.wb - header {
color:
    var(--cnblogs - toc - color);
background:
    transparent
...
.cnblogs - toc - pinned - navigator.wb - header.wb - icon{
    filter : invert(1)
                                                         ...
                                                         .cnblogs -
        toc - pinned - navigator.wb - body{
            background : transparent
        }

                                          .cnblogs -
        toc - pinned - navigator.cnblogs - toc{
            overflow : visible
        }
        ...
        toc - pinned - navigator.cnblogs - toc >
        .cnblogs - toc - title,
    .cnblogs - toc - pinned - navigator.cnblogs - toc - tips, .cnblogs - toc - pinned - navigator.cnblogs - toc - pinned - button{
        display : none
    }
...
.cnblogs - toc >.cnblogs - toc - bottom - toolbar >.cnblogs - toc - tips{
    margin : 0 0 0 5px
                                                                        ...
                                                                        .cnblogs -
                                                       toc >
                                                       .cnblogs - toc - bottom - toolbar >.cnblogs - toc - tips > a {
    font - size : inherit;
    font - weight : inherit;
color:
    inherit;
...
.tippy - box[data - animation = shift - away - subtle][data - state = hidden]{
    opacity : 0
             ...
             .tippy -
    box[data - animation = shift - away - subtle][data - state = hidden][data - placement ^= top]{
        transform : translateY(5px)
    }

        .tippy -
    box[data - animation = shift - away - subtle][data - state = hidden][data - placement ^= bottom]{
        transform : translateY(-5px)
    }

        .tippy -
    box[data - animation = shift - away - subtle][data - state = hidden][data - placement ^= left]{
        transform : translateX(5px)
    }

        .tippy -
    box[data - animation = shift - away - subtle][data - state = hidden][data - placement ^= right]{
        transform : translateX(-5px)
    }

        .tippy -
    box[data - theme ~= cnblogs] {
color:
    var(--cnblogs - toc - color);
...
transition:
    width.3s, height.3s, transform.3s, opacity.3s;
...
# 0d1117;
animation:
    wb - fade - in.2s ease - out forwards;
    z - index : -1
}
...
.hljs - comment{
    color : #697070
            ...
            .hljs -
    deletion,
    .hljs - number, .hljs - quote, .hljs - selector - class, .hljs - selector - id, .hljs - string, .hljs - template - tag, .hljs - type{
        color : #800
    }
    ...
    .hljs - title{
        color : #800
                ...
                .hljs -
        link,
    .hljs - operator, .hljs - regexp, .hljs - selector - attr, .hljs - selector - pseudo, .hljs - symbol, .hljs - template - variable, .hljs - variable{
        color : #ab5656
    }
...
transition:
    transform.15s ease - in - out, opacity.15s ease - in - out
}
...
.ui - dialog - footer button : active{
    ...
    .ui - dialog - footer button[disabled] : hover, .ui - dialog - footer button[disabled] : focus, .ui - dialog - footer button[disabled] : active {
    background - color : #fff;
    border - color : #ccc
}
...
.ui - dialog - footer button.ui - dialog - autofocus : active{
    background - image : none
                                                           ...
                                                           .ui -
    popup - top - left.ui - dialog,
    .ui - popup - top.ui - dialog, .ui - popup - top - right.ui - dialog{
        top : -8px
    }

                                                                      .ui -
                                       popup - bottom - left.ui - dialog,
    .ui - popup - bottom.ui - dialog, .ui - popup - bottom - right.ui - dialog{
        top : 8px
    }

                                                                            .ui -
                                          popup - left - top.ui - dialog,
    .ui - popup - left.ui - dialog, .ui - popup - left - bottom.ui - dialog{
        left : -8px
    }

                                                                         .ui -
                                        popup - right - top.ui - dialog,
    .ui - popup - right.ui - dialog, .ui - popup - right - bottom.ui - dialog{
        left : 8px
    }
...
.ui - popup - follow.ui - dialog - arrow - a, .ui - popup - follow.ui - dialog - arrow - b{
    display : block
                                                                                             ...
                                                                                             .ui -
                                                  popup - top - left.ui - dialog - arrow - a,
    .ui - popup - top.ui - dialog - arrow - a, .ui - popup - top - right.ui - dialog - arrow - a {
bottom:
    -16px;
...
.ui - popup - top - right.ui - dialog - arrow - a, .ui - popup - top - right.ui - dialog - arrow - b{
    right : 15px
                                                                                                       ...
                                                                                                       .ui -
                                                       popup - bottom - left.ui - dialog - arrow - a,
    .ui - popup - bottom.ui - dialog - arrow - a, .ui - popup - bottom - right.ui - dialog - arrow - a {
top:
    -16px;
...
.ui - popup - bottom - left.ui - dialog - arrow - a, .ui - popup - bottom - left.ui - dialog - arrow - b{
    left : 15px
                                                                                                           ...
                                                                                                           .ui -
                                                         popup - bottom.ui - dialog - arrow - a,
...
.ui - popup - bottom - right.ui - dialog - arrow - a, .ui - popup - bottom - right.ui - dialog - arrow - b{
    right : 15px
                                                                                                             ...
                                                                                                             .ui -
                                                          popup - left - top.ui - dialog - arrow - a,
    .ui - popup - left.ui - dialog - arrow - a, .ui - popup - left - bottom.ui - dialog - arrow - a {
right:
    -16px;
...
.ui - popup - left - bottom.ui - dialog - arrow - a, .ui - popup - left - bottom.ui - dialog - arrow - b{
    bottom : 15px
                                                                                                           ...
                                                                                                           .ui -
                                                         popup - right - top.ui - dialog - arrow - a,
    .ui - popup - right.ui - dialog - arrow - a, .ui - popup - right - bottom.ui - dialog - arrow - a {
left:
    -16px;
...
transform:
    rotate(360deg);
animation:
    ui - dialog - loading 1.5s infinite linear;
display:
    none\9
}
